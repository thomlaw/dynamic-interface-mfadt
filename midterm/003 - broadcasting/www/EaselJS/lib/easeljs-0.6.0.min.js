...
(function () {
    ...
    a.decodePath = function (a) {
        ...
        this.closePath], d = [2, 2, 4, 6, 0], c = 0, f = a.length, h = [], j = 0, k = 0, l = b.BASE_64; c < f;) {
            var n = a.charAt(c),
                p = l[n],
                q = p >> 3,
                s = g[q];
    ...
    b._getObjectsUnderPoint = function (a, b, g, d) {
        ...
        for (var k = this.children.length - 1; 0 <= k; k--) {
            ...
            if (l.visible && !(!n && !l.isVisible() || d && !l.mouseEnabled)) {
                ...
                if (l instanceof c && (!n || !p)) if (j) {
                        if (l = l._getObjectsUnderPoint(a, b)) return this
                    } else {
                        if (l = l._getObjectsUnderPoint(a, b, g, d), !g && l) return l
                    } else if (!d || j || p) if (l.getConcatenatedMatrix(h), n && (h.appendTransform(n.x, n.y, n.scaleX, n.scaleY, n.rotation, n.skewX, n.skewY, n.regX, n.regY), h.alpha = n.alpha),
